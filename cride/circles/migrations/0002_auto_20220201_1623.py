# Generated by Django 3.2.10 on 2022-02-01 22:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_admin', models.BooleanField(default=False, help_text='Los administradores de círculos pueden avtualizar los datos de los círculos y manegar sus miembros.', verbose_name='Admin círculo')),
                ...
                ('is_active', models.BooleanField(default=True, help_text='Sólo usuarios activos son permitidos para interactuar en un círculo.', verbose_name='Estado activo')),
                ...
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.profil')),
